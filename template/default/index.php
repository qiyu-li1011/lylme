	...
	<div class="container" style="margin-top:10vh; position: relative; z-index: 100;">
		...
		<div id="search" class="s-search">
			...
			<form action="https://www.bing.com/search?q=" method="get" target="_blank" id="super-search-fm">
				<input type="text" id="search-text" placeholder="搜索一下" style="outline:0" autocomplete="off" autofocus>
		...
		echo '<div id="lytoday"></div><script src="https://lytoday.lylme.com/?day=none&hot=weibo,douyin,bilibili">';
		include "footer.php";
		?>